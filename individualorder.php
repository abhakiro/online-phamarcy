...
<div id="tooplate_wrapper_sub">
	...
	$usernames=$_SESSION['username'];
	 $inbox= mysqli_query($con, "SELECT id, COUNT(drug_name) FROM cart where username='$username' and checkout='unchecked'");
	  ...
	  ?>
        <p class="basket"><a href="checkout.php">Drug order for <label class="lbasket"><?php echo $username; ?></label> </a></p>
        <p> </p>
	</div> <!-- end of middle -->
...
?>
   ...
   <tr>
    <td bgcolor="#ffffff"  class="tr">
      <?php  try{
	  $username=$_GET['username'];
	 $results = mysqli_query($con, "SELECT * FROM cart where checkout='checked' and username = '$username' and id & 1");
...
while($row = mysqli_fetch_array($results)){
	...
	$total=$quantity  * $price;
	 echo "<tr bgcolor='#FFFFFF'>";
	   ...
	   echo "</tr>";
	   echo "<tr bgcolor='#FFFFFF'>";
	 echo "<td  bordercolor='#FFFFFF' id='total'>"?><label class="total">Total : US$ </label> <?php echo $total. "</td>";
	   echo "</tr>";
...
?>
    ...
    <td bgcolor="#ffffff"  class="tr">
     <?php  try{
	 $username=$_GET['username'];
	 $results = mysqli_query($con, "SELECT * FROM cart where checkout='checked' and username = '$username' and MOD(id,2)=0");
	 echo "<table  border='0' width=100%' align='center' cellspacing='1' cellpadding'2' bgcolor='' cols='0' class='tbl'>
...
?>
   ...
   <tr class="tr">
    <td style="color: rgb(255, 255, 255);" bgcolor="#0099ff" colspan="2" class="tr"><STRONG>Thank you  Tinotenda  Siyabonga </STRONG></td>
     </tr>
     <tr>
      <td bgcolor='#FFFFFF' colspan="2">
...
<div id="tooplate_footer_wrapper">
    <div id="tooplate_footer">
    	...
    	<div class="col_allw300 col_last">
            ...
            Copyright © 2017 <a href="#">RealTimeTech Pharmaceuticals</a>
        </div>                 
