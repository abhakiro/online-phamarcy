...
<div id="tooplate_wrapper_sub">
	<div id="tooplate_header">
        ...
        <div id="tooplate_menu">
            ...
            <div id="search_box">
                <form action="ordersreports.php" method="post">
	...
	include "connect.php";
		$result = mysqli_query($con, "SELECT * FROM cart where checkout='checked'");
		
		if(isset($_POST['Search'])){
		if($_POST['searchfields']!=""){
		$result = mysqli_query($con,"SELECT * FROM `cart` where drug_name='$_POST[searchfields]' and checkout='checked' or quantity='$_POST[searchfields]' or price='$_POST[searchfields]' or username='$_POST[searchfields]' or date='$_POST[searchfields]' and checkout='checked' ");
				}else{
					 $result = mysqli_query($con, "SELECT * FROM cart where checkout='checked'");
					}
		}
...
while($row = mysqli_fetch_array($result))
  ...
  echo "<td  bordercolor='#FFFFFF'>" . $row['total'] . "</td>";
