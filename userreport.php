...
<div id="tooplate_wrapper_sub">
	...
	include "connect.php";
		...
		$result = mysqli_query($con,"SELECT * FROM `user` where name='$_POST[searchfields]' or surname='$_POST[searchfields]' or sex='$_POST[searchfields]' or access_level='$_POST[searchfields]' or home_address='$_POST[searchfields]' or date_of_birth='$_POST[searchfields]' ");
				}else{
					 $result = mysqli_query($con, "SELECT * FROM user");
					}
		}
echo "<table border='0' width='90%' align='center' class='tbls' cellspacing='0' cellpadding'2' bgcolor='#CCCCCC' cols='0'  >;
